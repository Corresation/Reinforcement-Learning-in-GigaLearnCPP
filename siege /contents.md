<div style="font-family: 'Consolas', 'Courier New', monospace; background-color:#0d0d0d; color:#e0e0e0; padding:40px; border-radius:10px;">
  ...
  <p style="line-height:1.6;">
    Siege is my personal (and experimental) Rocket League bot built using GigaLearnCPP.<br>
  ...
  <p style="line-height:1.6;">
    Siege will eventually become my reference bot for creating better bots, and those future bots will follow the same pattern.
  </p>
  ...
  <p style="line-height:1.6;">
    Yes, absolutely!<br>
    The initial version of Siege is purely experimental, and attempts to maximize its ability will use the basics as best as possible.<br>
